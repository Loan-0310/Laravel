                ...
                <div class="row d-flex flex-wrap justify-content-between">
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-menu menu-001">
                            <img src="asetss/images/dark-logo.png" alt="logo">
        ...
        <div class="row d-flex flex-wrap justify-content-between mb-3">
            <div class="col-md-4 col-sm-6">
                <div class="Shipping d-flex">
                    <p>We ship with:</p>
                    <div class="card-wrap">
                        <img src="asetss/images/dhl.png" alt="visa">
                        <img src="asetss/images/shippingcard.png" alt="mastercard">
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="payment-method d-flex justify-content-md-center">
                    <p>Payment options:</p>
                    <div class="card-wrap">
                        <img src="asetss/images/visa.jpg" alt="visa">
                        <img src="asetss/images/mastercard.jpg" alt="mastercard">
                        <img src="asetss/images/paypal.jpg" alt="paypal">
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
...
<!-- script ================================================== -->
<script src="asetss/js/jquery-1.11.0.min.js"></script>
<script src="asetss/js/plugins.js"></script>
<script src="asetss/js/script.js"></script>
